...
# ====================================================================================================================================== #
# Training Path
Train_Path = "/Users/miguelangelmarinesolvera/Desktop/final_project/dataset/seg_train/seg_train"

# Testing Path
Test_Path = "/Users/miguelangelmarinesolvera/Desktop/final_project/dataset/seg_test/seg_test"
...
# train_loader = DataLoader(datasets.ImageFolder(Train_Path, train = True, transform = transformer), batch_size = 32, sampler = sampler.SubsetRandomSampler(range(600)))
...
def train(model, optimiser, epochs):
    ...
    for epoch in range(epochs):
        ...
        if(acc > best_accuracy):
            ...
            # Save Best Model ----------------------------------------------------------------------------------------------------------
            torch.save(model1.state_dict(), '/Users/miguelangelmarinesolvera/Desktop/final_project/resnet34_modified.model')
